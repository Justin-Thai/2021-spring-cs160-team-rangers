...
export enum DispatchTypes {
	...
	FETCH_ALL_STUDY_REPORTS_STARTED = 'FETCH_ALL_STUDY_REPORTS_STARTED',
	FETCH_ALL_STUDY_REPORTS_SUCCESS = 'FETCH_ALL_STUDY_REPORTS_SUCCESS',
	FETCH_ALL_STUDY_REPORTS_FAILURE = 'FETCH_ALL_STUDY_REPORTS_FAILURE',
}
